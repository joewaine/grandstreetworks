...
PAGES = {
    ...
    "d2-two-week.html": {
        ...
        "copy": {
            ...
            _CLOSE: "Most major insurance accepted. Urgent slots held weekly, so ring rather than booking online if something has changed quickly.",
    ...
    "d3-the-spot.html": {
        ...
        "copy": {
            _SUB: "Medical dermatology, skin cancer surgery and a separate cosmetic clinic. If something has changed shape, colour or size, that is the appointment to make this week, and anything suspicious is biopsied at the same visit.",
